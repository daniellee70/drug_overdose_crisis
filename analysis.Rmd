...
The code in the anlaysis can be found in my GitHub account. Click [here](https://github.com/soungl/Entrepreneurial-Activity-in-Lakes-Region).
...
data <- read.csv("data/drugDeaths_year.csv")
...
```{r}
# Import data
data <- read.csv("data/drugDeaths_State.csv")
...
```{r}
# Import data
data <- read.csv("data/drugDeaths_age.csv")
...
```{r}
# Import data
data <- read.csv("data/drugDeaths_county.csv")
